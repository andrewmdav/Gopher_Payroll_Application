...
namespace GopherPayroll
{
    public partial class frmPayrollReview : Form
    {
        ...
        {
            //return current EmpID from Employee Table and pass it to the stored procedure that
            ...
            txtSN.Text = dsEmpInfo.Tables[0].Rows[intCurrRow]["SSAN"].ToString();
            txtPayRate.Text = dsEmpInfo.Tables[0].Rows[intCurrRow]["PayRate"].ToString();
